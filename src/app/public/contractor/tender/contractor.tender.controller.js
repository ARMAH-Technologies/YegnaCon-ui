...
(function () {
    ...
    angular
        ...
        .controller('ContractorTenderController', ContractorTenderController);
    /*@ngNoInject*/
    function ContractorTenderController($state,$rootScope, $stateParams,ContractorTenderService,PublicService,TenderService) {
        var vm = this;
        ...
        function getTenders(){
            ContractorTenderService.getTenders($stateParams.contractorId, vm.currentPage).then(function(response){
                debugger;
                if (response.data){
        ...
        function getUsersSelectedCategories(){
            debugger;
            PublicService.getUsersSelectedCategories($stateParams.contractorId,'Tender').then(function(response){
                debugger;
                if (response.data){
        ...
        function deleteTender(tenderId){
            ContractorTenderService.deleteTender(tenderId).then(function(response){
                getTenders();
            });
        }
