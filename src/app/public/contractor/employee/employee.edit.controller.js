(function () {
    ...
    /*@ngNoInject*/
    function EmployeeEditController(EmployeeService, $stateParams, $state, $window) {
        var vm = this;
        /*vm.leaves;*/
        ...
        function editEmployee() {
            ...
            var employee = {
                "data" : {
                    ...
                    "employer_id" : $stateParams.contractorId,
            ...
            EmployeeService.editEmployee($stateParams.contractorId,$stateParams.employeeId,employee).then(function (response) {
