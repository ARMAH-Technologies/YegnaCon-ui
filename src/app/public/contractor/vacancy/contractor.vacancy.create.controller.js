...
(function () {
    ...
    angular
        ...
        .controller('ContractorVacancyCreateController', ContractorVacancyCreateController);
    /*@ngNoInject*/
    function ContractorVacancyCreateController($state,$rootScope, $stateParams, ContractorVacancyService, CoreService) {
        var vm = this;
        ...
        function getVacancy(){
            ContractorVacancyService.getVacancy($stateParams.vacancyId).then(function(response){
        ...
        function createVacancy(isValid){
            if (isValid){
                ...
                ContractorVacancyService.createVacancy(vacancy).then(function(response){
                    debugger;
                    $state.go("main.public.contractorDashboard.vacancy");
                }, function(response){
                    debugger;
                });
            }
        ...
        function updateVacancy(){
            ...
            ContractorVacancyService.editVacancy(vacancy).then(function (response) {
                debugger;
