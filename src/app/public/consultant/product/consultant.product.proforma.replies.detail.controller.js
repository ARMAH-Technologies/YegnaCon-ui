...
(function () {
    ...
    angular
        ...
        .controller('ConsultantProductProformaDetailRepliesController', ConsultantProductProformaDetailRepliesController);
    /*@ngNoInject*/
    function ConsultantProductProformaDetailRepliesController($state, $stateParams, appConstant, ContractorService) {
        var vm = this;
        ...
        function getProductProformaDetail(proformaId) {
            ...
            ContractorService.getProformaReplyDetail(proformaId).then(function (response) {
                ...
                if (vm.productProforma.proformaRequest.data.file) {
                    vm.productProforma.proformaRequest.data.file.data.file_name = appConstant.imagePath + (vm.productProforma.proformaRequest.data.file.data.file_name);
                }
                ...
                for (var i = 0; i < response.data.proformaResponseItems.data.length; i++) {
                    vm.proformaResponseItems.push(
                        {
                            item_name: response.data.proformaRequest.data.proformaRequestItems.data[i].item_name,
                            description: response.data.proformaRequest.data.proformaRequestItems.data[i].description,
                            ...
                            unit: response.data.proformaResponseItems.data[i].unit,
