...
(function () {
    ...
    angular
        ...
        .controller('ConsultantProjectProformaController', ConsultantProjectProformaController);
    /*@ngNoInject*/
    function ConsultantProjectProformaController($state, $stateParams, $rootScope, ConsultantProjectService, CoreService, appConstant) {
        var vm = this;
        $rootScope.currentParentState = "consultantDashboard.projectProforma";
        ...
        function getCompanyProformas() {
            ConsultantProjectService.getCompanyProformas($stateParams.consultantId, vm.currentPage).then(function (response) {
                debugger;
        ...
        function getProformas() {
            ConsultantProjectService.getProformas($stateParams.consultantId, vm.currentPage2).then(function (response) {
                debugger;
