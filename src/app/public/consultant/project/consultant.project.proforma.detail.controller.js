...
(function () {
    ...
    angular
        ...
        .controller('ConsultantProjectProformaDetailController', ConsultantProjectProformaDetailController);
    /*@ngNoInject*/
    function ConsultantProjectProformaDetailController($state, $stateParams, appConstant, CoreService, ConsultantProjectService) {
        var vm = this;
        ...
        function getProformaDetail() {
            ConsultantProjectService.getProformaDetail($stateParams.proformaId).then(function (response) {
        ...
        function submitReply(isValid) {
            ...
            if (isValid) {
                ...
                ConsultantProjectService.replyProjectProforma(reply, $stateParams.contractorId, $stateParams.proformaId).then(function (response) {
                    if (response.data) {
